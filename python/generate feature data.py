...
feature_data = {'feature_selected': feature_matrix_selected,'feature_total':feature_matrix ,'label': label, 'transition_matrix': transition_matrix, 'EEGdata': data_total,'selected_idx':idx_select,'select_idx_total':idx_total}
savemat('feature_data.mat',feature_data)
